...
//                                //some dead uncles have children
    ...
    public static void main(String[] args) {
        ...
        while (dob == null) {
            System.out.println("Date of birth date cannot have invalid format");

            System.out.println("Enter birth date (yyyy-MM-dd):");
            dob = parseDate(scanner.nextLine());
        }
        ...
        while (dod == null) {
            System.out.println("Date of death date cannot have invalid format");

            System.out.println("Enter death date (yyyy-MM-dd):");
        ...
        for (int i = 0; i < numMarriages; i++) {
            ...
            while (marriageDate == null) {
                System.out.println("Marriage date cannot have invalid format");

                System.out.println("Enter marriage date (yyyy-MM-dd):");
                marriageDate = parseDate(scanner.nextLine());
            }

            System.out.println("Enter divorce date (yyyy-MM-dd):");
            String temp= scanner.nextLine();
            Date divorceDate = null;
            if (temp.length()>0) divorceDate = parseDate(temp);
